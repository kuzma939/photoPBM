  ...
  return (
    <footer className="bg-black text-white section-container">
      <div className="space-y-4">
        <h3 className="text-2xl md:text-3xl font-extrabold mb-8 text-left px-4 sm:px-6 tracking-tight">PIC BEST MOMENTS</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 border-t border-gray-400">
          <div className="border-b sm:border-b-0 md:border-r border-gray-400 px-4 sm:px-6 py-6">
            ...
            <p className="text-sm md:text-base font-semibold">
              <a href="mailto:photographbusiness01@gmail.com" className="hover:underline">
